...
public class LinkStateGUI {
	...
	private static void addFunctionalPanel() {
		...
		// Create Buttons
		ImageIcon ic1 = new ImageIcon("../Link State Routing Protocol/src/resource/network.png");
		btFun1 = new JButton("Create Network Topology", ic1);
		btFun1.setHorizontalTextPosition(SwingConstants.RIGHT);
		btFun1.setFont(font);

		ImageIcon ic2 = new ImageIcon("../Link State Routing Protocol/src/resource/scheme.png");
		btFun2 = new JButton("Connection Table", ic2);
		btFun2.setHorizontalTextPosition(SwingConstants.RIGHT);
		btFun2.setFont(font);

		ImageIcon ic3 = new ImageIcon("../Link State Routing Protocol/src/resource/path.png");
		btFun3 = new JButton("Shortest Path to Router", ic3);
		btFun3.setHorizontalTextPosition(SwingConstants.RIGHT);
		btFun3.setFont(font);

		ImageIcon ic4 = new ImageIcon("../Link State Routing Protocol/src/resource/topology.png");
		btFun4 = new JButton("Modify Topology", ic4);
		btFun4.setHorizontalTextPosition(SwingConstants.RIGHT);
		btFun4.setFont(font);

		ImageIcon ic5 = new ImageIcon("../Link State Routing Protocol/src/resource/router.png");
		btFun5 = new JButton("Broadcast Router", ic5);
		btFun5.setHorizontalTextPosition(SwingConstants.RIGHT);
		btFun5.setFont(font);

		ImageIcon ic6 = new ImageIcon("../Link State Routing Protocol/src/resource/logout.png");
